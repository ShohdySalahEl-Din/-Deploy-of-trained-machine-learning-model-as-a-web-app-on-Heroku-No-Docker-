...
def getPrediction(filename):
    ...
    #Load model
    my_model=tf.keras.models.load_model("model/HAM10000_100epochs (5).h5")
    
    SIZE = 32 #Resize to same size as training images
    img_path = 'D:/270 - How to deploy your trained machine learning model as a web app on Heroku (No Docker)/'+filename
